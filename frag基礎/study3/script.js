...
vec3 boxNormal(vec3 pos){
  ...
  return normalize(vec3(
    box(pos+ vec3(delta,0.,0.)) - box(pos - vec3(delta,0.,0.)),
    box(pos+ vec3(0.,delta,0.)) - box(pos - vec3(0.,delta,0.)),
    box(pos+ vec3(0.,0.,delta)) - box(pos - vec3(0.,0.,delta))
    ));
}
...
void main (void)
{
  ...
  // 物体の法線取得
  vec3 normal = boxNormal(rotation*ray.pos);
