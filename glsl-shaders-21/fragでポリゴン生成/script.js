...
float polygon(vec2 pt, vec2 center, float radius, float sides, float rotate, float edge_thickness){
  pt -= center;
...
void main (void)
{
  ...
  color += polygon(vUv,vec2(0.9 - sin(u_time*3.)*0.05, 0.5), 0.005, 3., 0., 0.001);
  color += polygon(vUv,vec2(0.1 - sin(u_time*3.+PI)*0.05, 0.5), 0.005, 3., PI, 0.001);
